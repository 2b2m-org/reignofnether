...
public class EntityRegistrar {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(Registries.ENTITY_TYPE, ReignOfNether.MOD_ID);

    private static final int UNIT_CLIENT_TRACKING_RANGE = 100;

    public static final DeferredHolder<EntityType<?>, EntityType<ZombieVillagerUnit>> ZOMBIE_VILLAGER_UNIT = ENTITIES.register("zombie_villager_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ZombieUnit>> ZOMBIE_UNIT = ENTITIES.register("zombie_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HuskUnit>> HUSK_UNIT = ENTITIES.register("husk_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<DrownedUnit>> DROWNED_UNIT = ENTITIES.register("drowned_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ZombiePiglinUnit>> ZOMBIE_PIGLIN_UNIT = ENTITIES.register("zombie_piglin_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ZoglinUnit>> ZOGLIN_UNIT = ENTITIES.register("zoglin_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SkeletonUnit>> SKELETON_UNIT = ENTITIES.register("skeleton_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<StrayUnit>> STRAY_UNIT = ENTITIES.register("stray_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BoggedUnit>> BOGGED_UNIT = ENTITIES.register("bogged_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CreeperUnit>> CREEPER_UNIT = ENTITIES.register("creeper_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SpiderUnit>> SPIDER_UNIT = ENTITIES.register("spider_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PoisonSpiderUnit>> POISON_SPIDER_UNIT = ENTITIES.register("poison_spider_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WraithUnit>> WRAITH_UNIT = ENTITIES.register("wraith_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<VillagerUnit>> VILLAGER_UNIT = ENTITIES.register("villager_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MilitiaUnit>> MILITIA_UNIT = ENTITIES.register("militia_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<VindicatorUnit>> VINDICATOR_UNIT = ENTITIES.register("vindicator_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PillagerUnit>> PILLAGER_UNIT = ENTITIES.register("pillager_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WindcallerUnit>> WINDCALLER_UNIT = ENTITIES.register("windcaller_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<IronGolemUnit>> IRON_GOLEM_UNIT = ENTITIES.register("iron_golem_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WitchUnit>> WITCH_UNIT = ENTITIES.register("witch_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EvokerUnit>> EVOKER_UNIT = ENTITIES.register("evoker_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EndermanUnit>> ENDERMAN_UNIT = ENTITIES.register("enderman_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<RavagerUnit>> RAVAGER_UNIT = ENTITIES.register("ravager_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WardenUnit>> WARDEN_UNIT = ENTITIES.register("warden_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SilverfishUnit>> SILVERFISH_UNIT = ENTITIES.register("silverfish_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GruntUnit>> GRUNT_UNIT = ENTITIES.register("grunt_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BruteUnit>> BRUTE_UNIT = ENTITIES.register("brute_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HeadhunterUnit>> HEADHUNTER_UNIT = ENTITIES.register("headhunter_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MarauderUnit>> MARAUDER_UNIT = ENTITIES.register("marauder_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HoglinUnit>> HOGLIN_UNIT = ENTITIES.register("hoglin_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HoglinUnit>> ARMOURED_HOGLIN_UNIT = ENTITIES.register("armoured_hoglin_unit",
            () -> EntityType.Builder.of(HoglinUnit::new, MobCategory.CREATURE)
                    .sized(EntityType.HOGLIN.getWidth(), EntityType.HOGLIN.getHeight())
                    .clientTrackingRange(UNIT_CLIENT_TRACKING_RANGE)
                    .build(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "armoured_hoglin_unit").toString()));

    public static final DeferredHolder<EntityType<?>, EntityType<BlazeUnit>> BLAZE_UNIT = ENTITIES.register("blaze_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WitherSkeletonUnit>> WITHER_SKELETON_UNIT = ENTITIES.register("wither_skeleton_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GhastUnit>> GHAST_UNIT = ENTITIES.register("ghast_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MagmaCubeUnit>> MAGMA_CUBE_UNIT = ENTITIES.register("magma_cube_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SlimeUnit>> SLIME_UNIT = ENTITIES.register("slime_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<RoyalGuardUnit>> ROYAL_GUARD_UNIT = ENTITIES.register("royal_guard_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EnchanterUnit>> ENCHANTER_UNIT = ENTITIES.register("enchanter_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<NecromancerUnit>> NECROMANCER_UNIT = ENTITIES.register("necromancer_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WretchedWraithUnit>> WRETCHED_WRAITH_UNIT = ENTITIES.register("wretched_wraith_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PiglinMerchantUnit>> PIGLIN_MERCHANT_UNIT = ENTITIES.register("piglin_merchant_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WildfireUnit>> WILDFIRE_UNIT = ENTITIES.register("wildfire_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PolarBearUnit>> POLAR_BEAR_UNIT = ENTITIES.register("polar_bear_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GrizzlyBearUnit>> GRIZZLY_BEAR_UNIT = ENTITIES.register("grizzly_bear_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PandaUnit>> PANDA_UNIT = ENTITIES.register("panda_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WolfUnit>> WOLF_UNIT = ENTITIES.register("wolf_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LlamaUnit>> LLAMA_UNIT = ENTITIES.register("llama_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PhantomSummon>> PHANTOM_SUMMON = ENTITIES.register("phantom_summon",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HeroExperienceOrb>> HERO_EXPERIENCE_ORB = ENTITIES.register("hero_experience_orb",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<KillerRabbitUnit>> KILLER_RABBIT_UNIT = ENTITIES.register("killer_rabbit_unit",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ThrowableTntProjectile>> THROWABLE_TNT_PROJECTILE = ENTITIES.register("tnt_throwable_projectile",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ThrownHeroExperienceBottle>> THROWN_HERO_EXPERIENCE_BOTTLE = ENTITIES.register("thrown_hero_experience_bottle",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AdjustablePrimedTnt>> ADJUSTABLE_PRIMED_TNT = ENTITIES.register("adjustable_primed_tnt",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<NecromancerProjectile>> NECROMANCER_PROJECTILE = ENTITIES.register("necromancer_projectile",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WindcallerProjectile>> WINDCALLER_PROJECTILE = ENTITIES.register("windcaller_projectile",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WraithSnowball>> WRAITH_SNOWBALL = ENTITIES.register("wraith_snowball",
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MoltenBombProjectile>> MOLTEN_BOMB_PROJECTILE = ENTITIES.register("molten_bomb_projectile",
