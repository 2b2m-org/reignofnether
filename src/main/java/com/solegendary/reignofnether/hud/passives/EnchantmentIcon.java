...
public class EnchantmentIcon extends Button {
    ...
    public EnchantmentIcon(ResourceKey<Enchantment> enchantment, EquipmentSlot slot, ResourceLocation iconRl, @Nullable List<FormattedCharSequence> tooltipLines) {
        super("Passive Icon", ICON_SIZE, iconRl, (Keybinding) null, () -> false, () -> true, () -> true, null, null, tooltipLines);
        this.enchantment = enchantment;
        this.slot = slot;
    }

    public EnchantmentIcon(ResourceKey<Enchantment> enchantment, EquipmentSlot slot, ItemStack iconItem, @Nullable List<FormattedCharSequence> tooltipLines) {
